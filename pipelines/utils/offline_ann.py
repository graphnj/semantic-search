...
sys.path.append('./')
import paddle
from pipelines.utils import convert_files_to_dicts, fetch_archive_from_http, convert_files_to_dicts_pmy
...
def offline_ann(index_name, doc_dir):
    ...
    dicts = convert_files_to_dicts_pmy(dir_path=doc_dir,
